...
**v1.0.3** on [`main`](https://github.com/Sqube-Groups/sqube-agent-control/tree/main) — Python is the reference SDK; Node and Rust implement the shared execution contract ([`tests/contract/`](tests/contract/)). See [CHANGELOG.md](CHANGELOG.md) and [V1_SYNC_SEMANTICS.md](tests/contract/V1_SYNC_SEMANTICS.md).

## SDKs

| Language | Package | Path |
|----------|---------|------|
| Python | [`sqube-agent-guard`](https://pypi.org/project/sqube-agent-guard/) **1.0.3** (PyPI) | `src/sqube_agent_guard/` |
| Node.js | [`sqube-agent-guard`](https://www.npmjs.com/package/sqube-agent-guard) **1.0.3** (npm) | [`nodejs/`](nodejs/) |
