...
**v1.0** on branch `feat/v1.0-core` — Python is the reference SDK; Node and Rust implement the shared execution contract (`tests/contract/`). See [CHANGELOG.md](CHANGELOG.md) and [V1_SYNC_SEMANTICS.md](tests/contract/V1_SYNC_SEMANTICS.md).
